...
WebUI.setText(findTestObject('Object Repository/mom_search/Page_Daftar Layanan Kesehatan  Gaya Hidup di Indonesia/input_Daftar Layanan_searchMerchantInput'), 
    'Cherry')

WebUI.sendKeys(findTestObject('Object Repository/mom_search/Page_Daftar Layanan Kesehatan  Gaya Hidup di Indonesia/input_Daftar Layanan_searchMerchantInput'), 
    Keys.chord(Keys.ENTER))

WebUI.verifyElementPresent(findTestObject('Object Repository/mom_search/Page_Cherry/a_Cherry Mom n Baby Spa'), 0)
