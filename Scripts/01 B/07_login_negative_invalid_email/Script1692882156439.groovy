...
WebUI.setText(findTestObject('Object Repository/mom_login/Page_Masuk ke Akun/input_Kata Sandi_form_login_password'), 'Ayu1234')
...
WebUI.verifyElementPresent(findTestObject('Object Repository/mom_login/Page_Masuk ke Akun/div_Data login yang anda masukkan salah'), 
    0)
