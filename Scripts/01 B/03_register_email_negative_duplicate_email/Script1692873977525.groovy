...
WebUI.setText(findTestObject('Object Repository/mom_register/Page_Daftar Ruangmom  Buat Akun Baru/input_Kata Sandi_form_daftar_password'), 
    'Ayu123')

WebUI.setText(findTestObject('Object Repository/mom_register/Page_Daftar Ruangmom  Buat Akun Baru/re-pass'), 'Ayu123')

WebUI.setText(findTestObject('Object Repository/mom_register/Page_Daftar Ruangmom  Buat Akun Baru/input_Nama panggilan Mom_form_daftar_nick_name'), 
    'Bunda')

WebUI.click(findTestObject('Object Repository/mom_register/Page_Daftar Ruangmom  Buat Akun Baru/input_Nama panggilan Mom_ant-radio-input'))

WebUI.click(findTestObject('Object Repository/mom_register/Page_Daftar Ruangmom  Buat Akun Baru/button_Daftar'))

WebUI.verifyElementPresent(findTestObject('Object Repository/negative scenario/Page_Daftar Ruangmom  Buat Akun Baru/div_E-mail sudah terdaftar, silahkan coba dengan alamat e-mail lain ya Mom vyt'), 
    0)
