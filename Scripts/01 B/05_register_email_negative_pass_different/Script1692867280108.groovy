...
WebUI.setText(findTestObject('Object Repository/mom_register/Page_Daftar Ruangmom  Buat Akun Baru/re-pass'), 'Ayu123456')

WebUI.verifyElementPresent(findTestObject('Object Repository/negative scenario/Page_Daftar Ruangmom  Buat Akun Baru/div_Konfirmasi kata sandi tidak sesuai'), 
    0)
